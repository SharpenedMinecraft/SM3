    ...
    public sealed class Player : Living
    {
        ...
        public override IEnumerable<IWriteablePacket> SpawnPackets
        {
            get {
                ...
                yield return new Network.Play.EntityStatus(Id, (byte) EntityStatus.SetOpLevel4);
                yield return new Network.Play.EntityStatus(Id, (byte) EntityStatus.DisableReducedDebugInfo);
            }
        }
