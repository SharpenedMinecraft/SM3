...
namespace SM3.Network.Handshaking
{
    public struct Handshake : IReadablePacket
    {
        ...
        public readonly ConnectionStage Stage => ConnectionStage.Handshaking;
        
        public int ProtocolVersion;
        public string ServerAddress;
        public short Port;
        public ConnectionStage NextStage;
        ...
        public void Read(IPacketReader reader)
        {
            ...
            NextStage = (ConnectionStage) reader.ReadVarInt();
        }
        ...
        public readonly void Process(ILogger logger, IConnectionState connectionState, IServiceProvider serviceProvider)
        {
            ...
            if (Constants.ProtocolVersion != ProtocolVersion && NextStage == ConnectionStage.Login)
            {
                var msg = $"Version missmatch. Server: {Constants.ProtocolVersion} ({Constants.VersionName}), Client: {ProtocolVersion}";
