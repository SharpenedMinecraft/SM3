...
namespace SM3.Network.Login
{
    public struct LoginStart : IReadablePacket
    {
        ...
        public readonly ConnectionStage Stage => ConnectionStage.Login;
        ...
        public readonly void Process(ILogger logger, IConnectionState connectionState, IServiceProvider serviceProvider)
        {
            ...
            ref var player = entityManager.Create<Player>();
            ...
            entityManager.Spawn(player.SpawnPackets);
            ...
            connectionState.ConnectionStage = ConnectionStage.Playing;
            ...
            connectionState.PacketQueue.Write(
                new DeclareCommands(serviceProvider.GetRequiredService<ICommandProvider>().SortedCommandInfos));
            connectionState.PacketQueue.Write(new UnlockRecipes());
            connectionState.PacketQueue.Write(new PlayerPositionAndLook(
                connectionState.PlayerEntity.Position, RotationHelper.FromLookAt(connectionState.PlayerEntity.LookDir),
                PlayerPositionAndLook.Flags.None,
                serviceProvider
            ...
            var halfViewDistance = connectionState.PlayerEntity.Settings.RenderDistance > 0
                ? connectionState.PlayerEntity.Settings.RenderDistance / 2
                : 4;
